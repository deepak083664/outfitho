...
const Dashboard = () => {
  const user = { name: 'Deepak Kumar', email: 'deepak@outfitho.com', memberSince: '2024' };
          ...
          <aside className="w-full lg:w-72 shrink-0">
             <div className="bg-white rounded-xl shadow-card border border-border p-1 lg:p-2 overflow-hidden">
                <nav className="flex lg:flex-col overflow-x-auto no-scrollbar lg:space-y-1">
                   ...
                   <button className="flex-shrink-0 flex items-center p-3 lg:p-4 rounded-lg text-red-500 font-black uppercase text-[10px] lg:text-[11px] tracking-widest hover:bg-red-50 transition-all whitespace-nowrap">
